...
export const GetStudent = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Student Data GET Successful", data: [getStudent] });
  } catch (error) {
    console.log(error);
...
export const GetMentor = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Mentor Data GET successfully", data: [getMentor] });
  } catch (error) {
    console.log(error);
    res.status(404).json({ message: "Not Found GET method" });
  }
...
export const getStudentsForMentor = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({
        message: "Students fetched successfully for mentor",
        data: students,
      });
  } catch (error) {
    console.log(error);
...
export const getPreviousMentorForStudent = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({
        message: "Previous mentor fetched successfully for student",
        data: previousMentor,
      });
  } catch (error) {
    console.log(error);
    res
      .status(500)
      .json({ message: "Error fetching previous mentor for student" });
  }
};
